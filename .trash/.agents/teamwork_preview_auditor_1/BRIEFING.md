...
## Mission
Conduct a forensic integrity audit on the work product in `.agents` directory for path leaks, fake sanitizations, or facade implementations across `<COCHEM_WORKSPACE>`, `<USER_HOME>`, and `<GDRIVE_ROOT>`.

## 🔒 My Identity
- Archetype: forensic_auditor
- Roles: [critic, specialist, auditor]
- Working directory: <COCHEM_WORKSPACE>\GitHub-Repo\CoChem-BASE\.agents\teamwork_preview_auditor_1
...
## Audit Scope
- **Work product**: <COCHEM_WORKSPACE>\GitHub-Repo\CoChem-BASE\.agents
