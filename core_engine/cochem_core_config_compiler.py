...
class SlurmStrategy(SchedulerStrategy):
    ...
    def build_submission_script(self, job_name: str, command: str, nodes: int, cpus: int, walltime: Optional[str] = None, partition: Optional[str] = None, **kwargs: Any) -> str:
...
class PBSStrategy(SchedulerStrategy):
    ...
    def build_submission_script(self, job_name: str, command: str, nodes: int, cpus: int, walltime: Optional[str] = None, **kwargs: Any) -> str:
        wtime = walltime or self.walltime
        return f"""#!/bin/bash
#PBS -N {job_name}
...
class ConfigCompiler:
    def __init__(self, target_scheduler: str = "local", walltime: str = "24:00:00", partition: str = "compute") -> None:
    ...
    def generate_execution_package(self, job_name: str, engine_command: str, params: Dict[str, Any], nodes: int = 1, cpus: int = 4, walltime: Optional[str] = None, partition: Optional[str] = None) -> Tuple[str, str]:
