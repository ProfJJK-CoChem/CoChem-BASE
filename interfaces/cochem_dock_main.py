...
class TelemetryMessage(BaseModel):
    """Pydantic model for structural validation of incoming telemetry JSON."""
...
async def websocket_telemetry(websocket: WebSocket) -> None:
    ...
    try:
        while True:
            # Structurally prevent TimeoutError by natively awaiting the socket instead of wait_for.
