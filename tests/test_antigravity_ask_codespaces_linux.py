...
def test_antigravity_ask_codespaces_linux(setup_env):
...
def main():
    ...
    assert os.environ.get("COCHEM_CALCULATION_OS") == "linux"
    ...
    try:
        ...
        res = daemon_instance.query('Hello from Linux codespaces')
        print("RESULT:", res)
...
if __name__ == "__main__":
    main()
"""
    artifacts_dir = os.environ.get("COCHEM_ARTIFACTS_DIR", tempfile.gettempdir())
    ...
    try:
        subprocess.run(
            ...
            env=setup_env,
            input="GENERIC_NEUTRAL_TOKEN_LINUX_TEST\\n",
            capture_output=True,
            text=True,
            timeout=15,
            check=True
